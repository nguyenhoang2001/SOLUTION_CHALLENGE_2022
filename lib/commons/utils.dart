...
import 'package:solution_challenge_2022/controllers/FBCloudStore.dart';
import 'package:solution_challenge_2022/controllers/localTempDB.dart';
import 'const.dart';
...
class Utils{
  ...
  static Future<MyProfileData> updateLikeCount(DocumentSnapshot data, bool isLikePost,MyProfileData? myProfileData,ValueChanged<MyProfileData> updateMyData, bool isThread) async {
    ...
    MyProfileData myNewProfileData = MyProfileData(
        ...
        myLikeCommnetList: isThread ? myProfileData.myLikeCommnetList : newLikeList, myFCMToken: ''
    );
